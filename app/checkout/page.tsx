  ...
  return (
    <div className="container mx-auto max-w-2xl py-12 px-4">
      <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col md:flex-row gap-8">
        <img src={image} alt={name} className="w-full md:w-64 h-64 object-cover rounded-xl" />
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-4 text-sm mb-2">
              <span className="flex items-center gap-1"><StarIcon size={16} className="text-yellow-500" /> {rating}</span>
            ...
            <div className="text-gray-700 font-semibold mb-2">From: <span className="text-purple-700">{restaurant}</span></div>
          </div>
